...
for cmd in git curl rsync xz debootstrap qemu-arm parted losetup mount umount sha256sum ssh-keygen; do check_cmd "$cmd"; done
...
for path in \
  ...
  lib/oled.py lib/config_model.py lib/update_runner.py lib/update_admin.py \
