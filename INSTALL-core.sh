...
apt-get update
apt-get install -y --no-install-recommends build-essential git ca-certificates libmosquitto-dev libmosquitto1 nlohmann-json3-dev python3 python3-dev python3-pip python3-smbus i2c-tools iw sudo default-jdk-headless
